...
<html lang="en">
  ...
  <body>
    ...
    ?>
    <h3 class="text-monospace text-center">LAPORAN DATA MAHASISWA</h3>
    ...
    <a href="CRMAHASISWA.php" target="blank" class="btn btn-dark font-weight-bold text-monospace">CETAK</a>
